      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
              <p id="prevEyer">
                <strong>AR OD:</strong> <span class="text-primary">{{ $bookings[0]->arod_sphere != 'No Target' ? ($bookings[0]->arod_sphere) . ' - ' . ($bookings[0]->arod_cylinder>0 ? '+' . $bookings[0]->arod_cylinder : $bookings[0]->arod_cylinder) . ' x ' . $bookings[0]->arod_axis : 'No Refraction Possible' }}</span>&nbsp;&nbsp;<span class="text-muted">|</span>&nbsp;&nbsp;
