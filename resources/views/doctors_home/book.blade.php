            ...
            <div class="card mb-3">
              ...
              <div class="card-body">
                <div class="form-floating mb-3">
                  ...
                  <input class="form-control" list="icdCodeList" id="{{ $viewFolder }}_prev_icd_code" name="{{ $viewFolder }}[icd_code]" value="{{ isset($bookings[0]->icd_code_obj->icd_code) && !empty($bookings[0]->icd_code_obj->details) ? $bookings[0]->icd_code_obj->icd_code . ' - ' . $bookings[0]->icd_code->details : '' }}" autocomplete="off" disabled>
