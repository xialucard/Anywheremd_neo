                                        ...
                                        @for($i=1; $i<=date('t', strtotime($yr . '-' . $mon . '-1')); $i++)
                                            ...
                                            <tr>
                                                ...
                                                <td class="{{ $border }} {{ $textColor }}">
                                                    @if(strtotime($yr . '-' . $mon . '-' . $i) >= strtotime('- 5 days'))
                                ...
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        @php
                                            ...
                                            //     $li_active = "active";
                                        @endphp
                                        <a class="nav-link {{ $li_active }}" aria-current="page" href="{{ route($viewFolder . '.index') . '/' . $yr . '/' . $mon . '/' . $dayNum . '/' . $in }}">{{ $in }} <span class="badge text-bg-{{ $bgColor }}">{{ $booking }}</span></a>
                                    </li>
                                            @endif
                                        @endforeach
                                    @endif
