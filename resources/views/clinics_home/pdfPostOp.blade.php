...
<body>
    ...
    <table border="1" cellspacing="0" cellpadding="5" width="100%">
        ...
        <tr>
            <td colspan="3">Things to expect after the procedure:<br><br><br></td>
        </tr>
        <tr>
            <td colspan="3">Things to watch out for:<br><br><br></td>
        </tr>
        <tr>
            <td colspan="3">Things to avoid:<br><br><br></td>
        </tr>
        <tr>
            <td colspan="3">Wound care:<br><br><br></td>
        </tr>
        <tr>
            <td colspan="3">Medications:<br><br><br></td>
        </tr>
        <tr>
