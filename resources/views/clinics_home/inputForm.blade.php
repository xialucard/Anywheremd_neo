...
<div class="card mb-3">
  ...
  <div class="card-body">
    ...
    <div class="form-floating mb-3">
      <input class="form-control" type="tel" pattern="[0-9]{4}-[0-9]{3}-[0-9]{4}" name="{{ $viewFolder }}[user][mobile_no]" id="{{ $viewFolder }}_rep_mobile_no" placeholder="" value="{{ !empty($datum->users[0]->mobile_no) ? $datum->users[0]->mobile_no : ''  }}" required>
