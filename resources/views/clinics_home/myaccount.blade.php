<div class="card mb-3">
  ...
  <div class="card-body">
    ...
    <div class="form-floating mb-3">
      <input class="form-control" type="tel" pattern="[0-9]{4}-[0-9]{4}" name="{{ $viewFolder }}[tel]" id="{{ $viewFolder }}_tel" placeholder="" value="{{ !empty($datum->clinic->tel) ? $datum->clinic->tel : ''  }}" required>
      <label for="{{ $viewFolder }}_tel" class="form-label">Tel #</label>
      <small id="help_{{ $viewFolder }}_tel" class="text-muted"></small>
    </div>
    <div class="form-floating mb-3">
      <input class="form-control" type="tel" pattern="[0-9]{4}-[0-9]{3}-[0-9]{4}" name="{{ $viewFolder }}[mobile_no]" id="{{ $viewFolder }}_mobile_no" placeholder="" value="{{ !empty($datum->clinic->mobile_no) ? $datum->clinic->mobile_no : ''  }}" required>
