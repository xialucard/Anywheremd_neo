            ...
            <table style="width: 100%; margin:0px; padding:0px;" border="1" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <th style="font-size: 7pt">{{ $temp != '' && ($flag%2) == 0 && $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[0]->tmp >= $temp && $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[0]->tmp < $temp+1  ? '*' : '' }}</th>
                        <th style="font-size: 7pt">
                            {{ $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[1]->bpS >= $bp && $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[1]->bpS < $bp+10  ? 'v' : '' }}
                            {{ $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[1]->bpD >= $bp && $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[1]->bpD < $bp+10  ? '^' : '' }}
                        </th>
                        <th style="font-size: 7pt">{{ $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[1]->heart >= $bp-10 && $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[1]->heart < $bp  ? 'x' : '' }}</th>
                        <th style="font-size: 7pt">{{ $temp != '' && ($flag%2) == 0 && $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[1]->tmp >= $temp && $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[1]->tmp < $temp+1  ? '*' : '' }}</th>
                        <th style="font-size: 7pt">
                            {{ $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[2]->bpS >= $bp && $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[2]->bpS < $bp+10  ? 'v' : '' }}
                            {{ $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[2]->bpD >= $bp && $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[2]->bpD < $bp+10  ? '^' : '' }}
                        </th>
                        <th style="font-size: 7pt">{{ $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[2]->heart >= $bp-10 && $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[2]->heart < $bp  ? 'x' : '' }}</th>
                        <th style="font-size: 7pt">{{ $temp != '' && ($flag%2) == 0 && $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[2]->tmp >= $temp && $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[2]->tmp < $temp+1  ? '*' : '' }}</th>
                        <th style="font-size: 7pt">
                            {{ $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[3]->bpS >= $bp && $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[3]->bpS < $bp+10  ? 'v' : '' }}
                            {{ $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[3]->bpD >= $bp && $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[3]->bpD < $bp+10  ? '^' : '' }}
                        </th>
                        <th style="font-size: 7pt">{{ $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[3]->heart >= $bp-10 && $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[3]->heart < $bp  ? 'x' : '' }}</th>
                        <th style="font-size: 7pt">{{ $temp != '' && ($flag%2) == 0 && $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[3]->tmp >= $temp && $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[3]->tmp < $temp+1  ? '*' : '' }}</th>
                        <th style="font-size: 7pt">
                            {{ $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[4]->bpS >= $bp && $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[4]->bpS < $bp+10  ? 'v' : '' }}
                            {{ $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[4]->bpD >= $bp && $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[4]->bpD < $bp+10  ? '^' : '' }}
                        </th>
                        <th style="font-size: 7pt">{{ $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[4]->heart >= $bp-10 && $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[4]->heart < $bp  ? 'x' : '' }}</th>
                        <th style="font-size: 7pt">{{ $temp != '' && ($flag%2) == 0 && $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[4]->tmp >= $temp && $datum->consultation_monitorings()->orderBy('id', 'asc')->get()[4]->tmp < $temp+1  ? '*' : '' }}</th>
                    </tr>
                    @endfor
                    <tr>
