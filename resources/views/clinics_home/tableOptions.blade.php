...
<div class="d-sm-flex flex-sm-row">
    ...
    @if (Route::has($viewFolder . '.sendDrainwiz') && ($dat->payment_mode == 'Philhealth' || $dat->payment_mode == 'Both' || $dat->payment_mode == 'Both Cash') && !isset($dat->opdpatient->id) && !is_null($dat->temp) && !is_null($dat->weight)  && !is_null($dat->bpS) && !is_null($dat->bpD) && is_null($dat->consultation_parent_id) && $dat->patient->phil_num != '')
