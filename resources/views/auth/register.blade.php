                ...
                <div class="card-header">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            @foreach ($selectItems['roles'] as $item)
                                @if (!$item['internal'])
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="m_name" type="text" class="form-control @error('m_name') is-invalid @enderror" name="m_name" value="{{ old('m_name') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="l_name" type="text" class="form-control @error('l_name') is-invalid @enderror" name="l_name" value="{{ old('l_name') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end">{{ __('Specialty') }}</label>

                            <div class="col-md-6">
                                <select class="form-control @error('specialty') is-invalid @enderror" name="specialty" id="expertise" required>
                                    <option value="">Select One</option>
                                    @foreach ($selectItems['specialties'] as $index=>$item)
                                        @if (sizeof($item)>0)
