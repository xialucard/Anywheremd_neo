...
Route::group(['middleware' => ['auth', 'permission']], function() {
    ...
    Route::get('clinics_home/{clinics_home}/pdfOrderSum', [ClinicsHomeController::class, 'pdfOrderSum'])->name('clinics_home.pdfOrderSum');
    ...
    Route::get('/doctors_home/getPrevBookingInfo/{doctors_home?}/{withHistory?}/{index?}', [DoctorsHomeController::class, 'getPrevBookingInfo'])->name('doctors_home.getPrevBookingInfo');
    Route::get('/doctors_home/getBookingInfo/{doctors_home?}', [DoctorsHomeController::class, 'getBookingInfo'])->name('doctors_home.getBookingInfo');
